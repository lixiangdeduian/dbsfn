...
GRANT SELECT ON hospital_test.v_patient_reception TO role_reception;
...
GRANT INSERT, UPDATE ON hospital_test.patient TO role_reception;
GRANT INSERT, UPDATE ON hospital_test.registration TO role_reception;
...
GRANT INSERT, UPDATE ON hospital_test.encounter TO role_doctor;
GRANT INSERT, UPDATE ON hospital_test.diagnosis TO role_doctor;
GRANT INSERT, UPDATE ON hospital_test.prescription TO role_doctor;
GRANT INSERT, UPDATE ON hospital_test.prescription_item TO role_doctor;
GRANT SELECT ON hospital_test.v_doctor_my_prescriptions_detail TO role_doctor;
GRANT INSERT, UPDATE ON hospital_test.lab_order TO role_doctor;
GRANT INSERT, UPDATE ON hospital_test.lab_order_item TO role_doctor;
...
GRANT INSERT, UPDATE ON hospital_test.admission TO role_nurse;
GRANT INSERT, UPDATE ON hospital_test.bed_assignment TO role_nurse;

-- role_pharmacist（药品/调剂）：
GRANT SELECT ON hospital_test.v_current_staff TO role_pharmacist;
GRANT SELECT ON hospital_test.v_drug_catalog_active TO role_pharmacist;
GRANT INSERT, UPDATE ON hospital_test.drug TO role_pharmacist;
...
GRANT INSERT, UPDATE ON hospital_test.dispense TO role_pharmacist;
GRANT UPDATE ON hospital_test.prescription TO role_pharmacist;
...
GRANT UPDATE ON hospital_test.lab_order TO role_lab_tech;
GRANT INSERT, UPDATE ON hospital_test.lab_result TO role_lab_tech;
...
GRANT INSERT, UPDATE ON hospital_test.invoice TO role_cashier;
GRANT INSERT, UPDATE ON hospital_test.invoice_line TO role_cashier;
GRANT INSERT, UPDATE ON hospital_test.payment TO role_cashier;
GRANT INSERT, UPDATE ON hospital_test.refund TO role_cashier;
GRANT INSERT, UPDATE ON hospital_test.charge TO role_cashier;
